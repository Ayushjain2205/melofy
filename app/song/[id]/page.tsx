...
import { LineChart, Line, XAxis, YAxis, ResponsiveContainer, CartesianGrid, type TooltipProps } from "recharts"
  ...
  return (
    <div className="bg-[#1A1522] border border-[#333] rounded-lg p-3 shadow-lg">
      <div className="space-y-1.5">
        ...
        <div className="text-[#a3ffae] text-sm font-mono font-bold">${value.toFixed(3)}</div>
      </div>
    </div>
  )
}
        ...
        <div className="mb-8">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-[#00FFFF] font-audiowide mb-1">{song.title}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="h-[400px]">
                ...
                >
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={song.data} margin={{ top: 20, right: 50, left: 0, bottom: 20 }}>
                      <defs>
                        <linearGradient id="lineGradient" x1="0" y1="0" x2="0" y2="1">
                          <stop offset="0%" stopColor="rgb(163, 255, 174)" stopOpacity={1} />
                          <stop offset="100%" stopColor="rgb(163, 255, 174)" stopOpacity={0.3} />
                        </linearGradient>
                      </defs>
                      <XAxis
                        dataKey="date"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#1A1522] border border-[#FF00FF]/20 rounded-lg p-6">
              <h2 className="text-xl font-bold text-[#00FFFF] font-audiowide mb-4">Song Details</h2>
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-mono">${song.price.toFixed(3)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-[#FF99D1] font-exo2">Bonding curve filled:</span>
                  <span className="text-white font-mono">{song.bondingCurve}%</span>
                </div>
              </div>
              <Button className="w-full mt-4 bg-zinc-800 text-white hover:bg-zinc-700 font-exo2" onClick={() => {}}>
            ...
            {/* Trading Interface */}
            <div className="bg-[#1A1522] border border-[#FF00FF]/20 rounded-lg p-6">
              <h2 className="text-xl font-bold text-[#00FFFF] font-audiowide mb-4">Trade</h2>
              <div className="flex justify-between mb-6">
                <Button className="flex-1 bg-[#00FFFF] text-[#0D0D15] hover:bg-[#66FFFF] font-exo2">Buy</Button>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-[#FF99D1] mb-2 font-exo2">Amount (ETH)</label>
                  <input
                    type="text"
                    value={amount}
                ...
                <Button className="w-full bg-[#FF00FF] text-white hover:bg-[#FF66B8] font-exo2">Place Trade</Button>
              </div>
            </div>
          </div>
        </div>
